...
GAYA: Profesional, santai, to the point, pake emoji dan poin. Jangan kepanjangan. Bahasa Indonesia. JANGAN PAKAI TANDA BINTANG ** DI JAWABAN.
DATA CLIENT: {brand_info}
ATURAN: Ingat semua data brand client. Jawab sesuai konteks chat sebelumnya.
"""
...
async def set_tone(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        f"Siap! Aku udah inget brand kamu: {brand_data['brand']} \n\n"
        f"Detail Brand:\n"
...
async def hermes_brain(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        bot_reply = response.text.replace("**", "") # JAGA2 KALAU GEMINI KELUARIN BINTANG
